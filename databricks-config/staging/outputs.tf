...
output "mlops-demo-classifier_batch_inference_job_id" {
...
output "mlops-demo-classifier_experiment_id" {
  value = databricks_mlflow_experiment.experiment.id
}

output "mlops-demo-classifier_experiment_name" {
...
output "mlops-demo-classifier_model_name" {
...
output "mlops-demo-classifier_training_job_id" {

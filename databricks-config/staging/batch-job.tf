resource "databricks_job" "batch_inference_job" {
  name = "${local.env_prefix}mlops-demo-classifier-batch-inference-job"
  ...
  new_cluster {
    ...
    # To enable your batch inference job to access the Unity Catalog, update the security mode of
